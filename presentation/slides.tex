...
\begin{frame}
  ...
  \makebox[\textwidth]{
    \begin{tikzpicture}
      \node (screenshot)
         {\includegraphics[width=0.50\paperwidth]{img/bitcoin.jpg}};
      \node (schema) at (screenshot.south east) [xshift=5em] [yshift=2.5ex]
         {\includegraphics[width=0.45\paperwidth]{img/neuron.jpg}};
      \node (goal) at (screenshot.north east) [xshift=4em] [yshift=2ex]
         {\includegraphics[width=0.45\paperwidth]{img/risk.png}};
    \end{tikzpicture}
  }
\end{frame}
